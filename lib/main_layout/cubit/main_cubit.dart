...
class MainCubit extends Cubit<MainState> {
  ...
  void saveAudioToFav({
    ...
    var file = await DefaultCacheManager().getSingleFile(link);
    ...
    storage.FirebaseStorage.instance
      ...
      p0.ref.getDownloadURL().then((downloadUrl) {
        AudioModel audioModel = AudioModel(ConstantsManger.defaultValue,
            FirebaseAuth.instance.currentUser!.uid, downloadUrl, true, text);
